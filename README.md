### DESIGN WEBSITE USING CSS

### AIM:
To Design a website like the below given images
    ...
    <main>
        <div class="contact-container">
            ...
            <div class="contact-info">
                ...
                <p><strong>Phone:</strong> 8440301297</p>
            </div>
        </div>
    </main>
    <footer>
        <p>DESIGNED AND DEVELOPED BY MATHAN (212221040102)</p>
    </footer>
</body>
</html>
